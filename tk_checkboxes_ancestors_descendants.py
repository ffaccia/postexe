...
create checkboxes and check ancestors and descendants

"""

os.chdir(r'C:\Users\f.faccia\Documents\Sviluppo\python\postexe\img')
...
class CheckboxTreeview(ttk.Treeview):
    ...
    def __init__(self, master=None, **kw):
        ...
        self.im_checked = tk.PhotoImage(file='checkedn.png')
        self.im_unchecked = tk.PhotoImage(file='uncheckedn.png')
        self.im_tristate = tk.PhotoImage(file='uncheckedn.png')
